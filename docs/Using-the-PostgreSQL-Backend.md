要使用 PostgreSQL 后端，您可以使用 [官方 Docker 映像](https://hub.docker.com/r/vaultwarden/server) 或构建您自己的二进制文件 [启用 PostgreSQL](https://github.com)。 com/dani-garcia/vaultwarden/wiki/Building-binary#postgresql-backend）。
